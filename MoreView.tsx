...
// Centralized mock settings (in a real app, this would be fetched from Convex/Backend)
const MOCK_SETTINGS = {
  deliveryFee: 3000,
};
...
export default function MoreView() {
  ...
  const [deliveryFee, setDeliveryFee] = useState(MOCK_SETTINGS.deliveryFee);
  ...
  const handleSave = () => {
    ...
    // Save
    MOCK_SETTINGS.deliveryFee = numValue;
