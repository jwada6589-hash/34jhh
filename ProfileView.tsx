...
import { MOCK_USER_SETTINGS } from '../shared/settings';

export default function ProfileView({ onViewChange }: { onViewChange: (view: string) => void }) {
  const { userProfile, updateUserProfile, setAuthState, wallet, walletTransactions, theme, toggleTheme } = useAppContext();
  ...
  const handleWhatsAppClick = () => {
    if (!MOCK_USER_SETTINGS.whatsappEnabled) return;
    const cleanNumber = MOCK_USER_SETTINGS.whatsappNumber.replace(/[^0-9+]/g, '');
    const encodedMessage = encodeURIComponent(MOCK_USER_SETTINGS.whatsappDefaultMessage);
        ...
        return (
          <div className="fixed inset-0 z-[100] bg-white dark:bg-gray-900 flex flex-col transition-colors">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <h3 className="text-xl font-black text-center text-gray-900 dark:text-white mb-2">{MOCK_USER_SETTINGS.storeName}</h3>
              <p className="text-center text-gray-500 dark:text-gray-400 font-medium mb-6">{MOCK_USER_SETTINGS.storeSubtitle}</p>
    ...
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-gray-900 pb-24 relative z-0">
      ...
      <div className="px-4 -mt-6 relative z-10 space-y-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-2 shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          <button className="w-full flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
            <div className="flex items-center gap-3">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-2 shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          {MOCK_USER_SETTINGS.whatsappEnabled && (
            <>
              <div className="h-px bg-gray-50 dark:bg-gray-700/50 mx-4"></div>
        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-sm shadow-xl p-6 text-center animate-in zoom-in-95 duration-200">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6 leading-relaxed">
              ...
              <br/>
              <span className="block mt-2 text-xs font-bold text-gray-400">(ملاحظة: النظام حالياً تجريبي، لن يتم حذف الحساب فعلياً من السيرفر)</span>
            </p>
