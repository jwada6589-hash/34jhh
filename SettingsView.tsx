...
import { MOCK_ADMIN_SETTINGS } from './mockData';
...
export default function SettingsView({ onLogout }: { onLogout: () => void }) {
  ...
  const handleSave = () => {
    ...
    setErrors({});
    // In a real app, save to Convex here
    Object.assign(MOCK_ADMIN_SETTINGS, settings);
  ...
  const handleLogout = () => {
    // Clear session and callback to parent to handle UI change
